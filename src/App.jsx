    ...
    <Route>
      ...
      >
        ...
        <Route
          path="/students/:id"
          element={
            <SelfOrBibliotekarRoute role="Student">
              <StudentProfile />
            </SelfOrBibliotekarRoute>
          }
